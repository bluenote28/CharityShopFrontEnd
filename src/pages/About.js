...
function AboutPage() {
    ...
    return (
        <>
           <h1 className="mt-4" style={{textAlign: "center"}}>About this site</h1>
           <Container>
                <p className="w-50 m-auto">The inspiration of this site was to create a site where everything on it benefits charity, similar to what 
                ...
                <ul className="w-50 m-auto mt-2">
                    <li>Its hidden. You have to know where it is to find it.</li>
                    <li>There is no easy way to do a general item search for things that benefits charity.<br />
                        For example, I cannot easily do a search for all Nintendo products which benefits charity.</li>
